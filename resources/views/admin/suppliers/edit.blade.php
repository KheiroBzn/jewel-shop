        ...
        <div class="row my-4 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body row">
                  ...
                  <form class="pt-3" action="{{ route('suppliers.update', ['supplier' => $supplier]) }}" method="POST">
                      @csrf
                      @method('PUT')
                      ...
                      <div class="row w-100 mx-0">
                          <div class="col-lg-4 col-md-6 col-sm-12 mx-auto my-auto">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="location" value="{{ $supplier->location }}"
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="tel" value="{{ $supplier->tel }}"
