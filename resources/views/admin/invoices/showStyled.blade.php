...
<div class="row my-4 mx-auto d-flex p-2">
  ...
  <div class="card">
      <div class="card-header row rounded-top bg-secondary bg-gradient">
          ...
          <div class="col-lg-4">
            <a href="{{ route('invoices.print', $invoice->id) }}" class="btn btn-info btn-sm float-right">
      ...
      <div class="card-body row">
        <div class="">
            <table class="bg-white border" align='center' border='0' cellpadding='0' cellspacing='0' style='height:842px; width:595px;font-size:12px;'>
                <tr>
                    <td valign='top'>
